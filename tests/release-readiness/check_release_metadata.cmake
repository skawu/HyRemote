...
if(NOT qml_export EQUAL -1)
    message(FATAL_ERROR
        "release-readiness: QML API backing library must not become a second C++ SDK target")
endif()
...
if(qpa_module EQUAL -1)
    message(FATAL_ERROR "release-readiness: QPA must remain a platform MODULE")
endif()
