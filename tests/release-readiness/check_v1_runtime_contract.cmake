...
require_file_token("src/integrations/cpp/tests/test_rfb_multi_client_input.cpp" "testConcurrentViewerHeldStateIsolation" "two-viewer deterministic held-state regression")
require_file_token("src/integrations/cpp/tests/test_rfb_multi_client_input.cpp" "countKey(inputs, hyremote::KeyCode::B, true) == 2" "same-viewer key repeat preservation")
...
require_file_token("src/integrations/cpp/tests/test_input_mailbox_admission.cpp" "testProtectedReserveBoundCoversWorstAcceptedLifecycle" "pure admission worst-case proof")
require_file_token("src/integrations/cpp/tests/CMakeLists.txt" "hyremote-input-mailbox-admission-test" "registered pure admission CTest")
