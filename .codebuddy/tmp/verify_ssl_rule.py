...
PATH = "C:/Qt/Tools/CMake_64/bin;C:/Qt/Tools/Ninja;C:/Qt/Tools/mingw1310_64/bin;C:/Qt/6.8.3/mingw_64/bin"
...
warning = [line for line in out.splitlines() if "HyRemote: the authenticated" in line
           or "no OpenSSL 3 development files" in line or "OpenSSL Toolkit" in line]
print("actionable warning present:", bool(warning))
for line in warning:
    print("  ", line.strip())
if rc != 0:
