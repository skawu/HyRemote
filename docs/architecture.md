...
HyRemote tests the **product promise and support claims**, not the current implementation topology or raw CTest count. The canonical product-test architecture is [`internal/test-strategy.md`](internal/test-strategy.md), with detailed evidence-system design in [`internal/test-system-architecture.md`](internal/test-system-architecture.md).
