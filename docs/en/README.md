...
| Integrate with the C++ API | [`getting-started/cpp.md`](getting-started/cpp.md) |
| Integrate with QML API | [`getting-started/qml.md`](getting-started/qml.md) |
| Use QPA without touching application source | [`../getting-started/qpa-proxy.md`](../getting-started/qpa-proxy.md) |
