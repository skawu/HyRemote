...
Physical/native evidence is tracked by #109. On the claimed Windows and Linux reference environments it must prove the applicable E1/E2/E3/E4 local-behavior cells, including:
